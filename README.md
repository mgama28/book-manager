...
- Member checkout list is not fully tied to checkout/return commands
...
Used in **BookBuilder, MovieBuilder, and MusicBuilder** to create library items with multiple fields through method chaining

---

### Command

Used to wrap catalog operations like **AddItemCommand, RemoveItemCommand, SearchItemCommand, CheckOutCommand, and ReturnItemCommand**. 
